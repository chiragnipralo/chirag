...
export class ChoosePlanPage implements OnInit {
  ...
  ngOnInit() {
    this.selectedType = this._route.snapshot.params['select_type'];
    console.log("Selected type ==>", this._route.snapshot.params['select_type'])
  ...
  // handleEventSelection(detailId: number, amount: number, validity:any) {
  //   this.selectedDetailId = detailId;
  //   this.selectedAmount = amount;
  //   this.detailsPlan = validity;
  // }
