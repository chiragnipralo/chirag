...
var EditEventPage = /** @class */ (function () {
    function EditEventPage(sanitizer, commonservice, formBuilder, common, dataservice, navCtrl, chatconnect, modalController, createv4omdal, successmodal, contactpagemodal, router, _route, location, alertController) {
    ...
    EditEventPage.prototype.dismissModal = function () {
        this.modalController.dismiss();
    };
    EditEventPage.prototype.toggleSelection = function (item) {
        item.selected = !item.selected;
    };
    EditEventPage.prototype.GetCords = function () {
        var _this = this;
    ...
    EditEventPage.prototype.onCategoryChange = function (event) {
        var _this = this;
        var apidata = {
    ...
    EditEventPage.prototype.GetDashboard = function () {
        var _this = this;
    ...
    EditEventPage.prototype.addPiece = function () {
    ...
    EditEventPage.prototype.addActivity = function () {
    ...
    EditEventPage.prototype.deleteActivity = function (i) {
        this.getActivityArray.removeAt(i);
    };
    EditEventPage.prototype.Addacti = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EditEventPage.prototype.deleteContact = function (i) {
        this.getEcontactArray.removeAt(i);
    };
    EditEventPage.prototype.addEmegenctyContact = function () {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 0:
                        ...
                        _loop_2 = function (i) {
                            ...
                            if (contactNameControl && contactNumberControl) {
                                ...
                                var contact_role = (contactRoleControl === null || contactRoleControl === void 0 ? void 0 : contactRoleControl.value) || '';
    ...
    EditEventPage.prototype.addPoll = function () {
    ...
    EditEventPage.prototype.deletePoll = function (i) {
        this.getPollArray.removeAt(i);
    };
    EditEventPage.prototype.addPollSection = function () {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 0:
                        ...
                        _loop_3 = function (i) {
                            ...
                            if (pollQuestionControl && pollOption1Control) {
                                ...
                                var poll_option2 = ((_a = pollGroup.get('poll_option2')) === null || _a === void 0 ? void 0 : _a.value) || '';
                                var poll_option3 = ((_b = pollGroup.get('poll_option3')) === null || _b === void 0 ? void 0 : _b.value) || '';
                                var poll_option4 = ((_c = pollGroup.get('poll_option4')) === null || _c === void 0 ? void 0 : _c.value) || '';
    ...
    EditEventPage.prototype.addfood = function () {
        var mulfood = this.formBuilder.group({
            extra_food_name: ['']
        });
        this.getfoodArray.push(mulfood);
    };
    EditEventPage.prototype.removefood = function (i) {
        this.getfoodArray.removeAt(i);
    };
    EditEventPage.prototype.addDrink = function () {
        var drinks = this.formBuilder.group({
            drinks_name: ['']
        });
        this.getdrinkArray.push(drinks);
    };
    EditEventPage.prototype.removeDrink = function (i) {
        this.getdrinkArray.removeAt(i);
    };
    EditEventPage.prototype.saveFoodItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var foodItemId;
            return __generator(this, function (_a) {
    ...
    Object.defineProperty(EditEventPage.prototype, "getPiecesArray", {
        get: function () {
    ...
    Object.defineProperty(EditEventPage.prototype, "getActivityArray", {
        get: function () {
    ...
    Object.defineProperty(EditEventPage.prototype, "getEcontactArray", {
        get: function () {
    ...
    Object.defineProperty(EditEventPage.prototype, "getfoodArray", {
        get: function () {
    ...
    Object.defineProperty(EditEventPage.prototype, "getdrinkArray", {
        get: function () {
    ...
    Object.defineProperty(EditEventPage.prototype, "getPollArray", {
        get: function () {
    ...
    EditEventPage.prototype.loadImagesFromDeviceMulti = function (event) {
        var _this = this;
    ...
    EditEventPage.prototype.removeImage = function (index) {
        this.menuUrls.splice(index, 1);
        this.selectedFiles.splice(index, 1);
    };
    EditEventPage.prototype.submit = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.chatconnect.postFormData(formData, "edit_event").then(function (result) {
                            _this.common.hide();
                            if (result.Response.status == 1) {
    ...
    EditEventPage.prototype.view = function (img, showflag) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    EditEventPage.prototype.ChangeFood = function (event) {
        var _this = this;
    ...
    EditEventPage.prototype.loadImageFromDevice = function (event, showflag) {
        var _this = this;
    ...
    ;
    EditEventPage.prototype.goToNextSegment = function () {
    ...
    EditEventPage.prototype.goToPreviousSegment = function () {
        var segments = ['1', '2', '3', '4'];
        var currentIndex = segments.indexOf(this.segment);
        if (currentIndex > 0) {
            this.segment = segments[currentIndex - 1];
    ...
    EditEventPage.prototype.removevalue = function (i) {
        this.values.splice(i, 1);
    };
    EditEventPage.prototype.addvalue = function () {
        this.values.push({ value: "" });
    };
    EditEventPage.prototype.onAgeChange = function () {
    ...
    EditEventPage.prototype.removePrevImage = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    EditEventPage.prototype.openModal = function (originalEventImages) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        this.chatconnect.postData(apidata, "view_events_by_id").then(function (result) {
            ...
            if (result.Response.status == 1) {
                ...
                if (eventDates && eventDates.length > 0) {
                    var formArray_1 = _this.ionicForm.get('event_dates');
                    formArray_1.clear();
                ...
                if (eventData_1 && eventData_1.event_food_type && eventData_1.event_food_type[0] && eventData_1.event_food_type[0].food_type) {
                ...
                if (multi_food && multi_food.length > 0) {
                    var formArray_2 = _this.ionicForm.get('food_section');
                    formArray_2.clear();
                ...
                if (multi_drinks && multi_drinks.length > 0) {
                    var formArray_3 = _this.ionicForm.get('drink_section');
                    formArray_3.clear();
    ...
    ], EditEventPage.prototype, "moreBar");
    __decorate([
        core_1.ViewChild(angular_1.IonTextarea)
    ], EditEventPage.prototype, "textarea");
