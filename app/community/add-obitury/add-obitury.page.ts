...
@Component({
  selector: 'app-add-obitury',
  templateUrl: './add-obitury.page.html',
  styleUrls: ['./add-obitury.page.scss'],
})
export class AddObituryPage implements OnInit {
  ...
  async submit() {
    ...
    if (!this.ionicForm.valid){
      ...
      const id = this.navParams.get('community_id');
  ...
  async ngOnInit() {
    ...
    console.log("THis is CommunityID:",this.navParams.get('community_id'));
